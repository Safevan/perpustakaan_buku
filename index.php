...
left: 200px;
 ...
 td a{
  ...
  <body>
    ...
    <div class="image">
 <img src="./gambar/tulisandaftarbuku.png" width="350px" >
</div><center>
    ...
    <tbody>
      ...
      ?>
       ...
       <tr>
          ...
          <td>
              <a href="edit_buku.php?id=<?php echo $row['id_buku']; ?>" class = "edit"> Edit</a> 
              <a href="proses_hapus.php?id=<?php echo $row['id_buku']; ?>" class = "hapus" onclick="return confirm('Anda yakin akan menghapus buku ini?')">Hapus</a>
          </td>
      </tr>
      <?php
